...
DROP SEQUENCE SEQ_MLPBOARD;
DROP TABLE MLPBOARD;
CREATE SEQUENCE SEQ_MLPBOARD NOCACHE;
CREATE TABLE MLPBOARD(
	NO NUMBER PRIMARY KEY,
	...
	RELEASE VARCHAR2(2000),
	REGDATE DATE
);
INSERT INTO MLPBOARD VALUES(SEQ_MLPBOARD.NEXTVAL,'박상은','글1','내용1','키워드1','비공개',SYSDATE);
SELECT * FROM MLPBOARD;
SELECT * FROM MLPBOARD ORDER BY NO DESC;

SELECT * FROM MLPBOARD ORDER BY NO ASC;
DROP TABLE MYBOARD;
CREATE TABLE MYBOARD(
	MYNO NUMBER PRIMARY KEY,
...
INSERT INTO MYBOARD VALUES(SEQ_MY.NEXTVAL, '관리자','스프링 테스트','SPRING MVC 재밌다...',SYSDATE);
...
CREATE TABLE TESTBOARD(
	...
	TESTNAME VARCHAR2(1000) NOT NULL,
	TESTID VARCHAR2(1000) NOT NULL,
	TESTTITLE VARCHAR2(1000) NOT NULL,
	TESTCONTENT VARCHAR2(1000) NOT NULL,
	TESTDATE DATE NOT NULL
);
INSERT INTO TESTBOARD VALUES(SEQ_TBOARD.NEXTVAL, '홍길동','user1','제목1','내용1',SYSDATE);
CREATE SEQUENCE SEQ_TBOARD NOCACHE;
CREATE SEQUENCE SEQ_TMEMBER NOCACHE;
CREATE TABLE TESTMEMBER(
	MEMNO NUMBER PRIMARY KEY,
	MEMID VARCHAR2(1000) NOT NULL,
	MEMPW VARCHAR2(1000) NOT NULL,
	MEMNAME VARCHAR2(1000) NOT NULL
);
INSERT INTO TESTMEMBER VALUES(SEQ_TMEMBER.NEXTVAL,'admin','1234','관리자');
...
INSERT INTO EMP VALUES(100,'SMITH',103);
INSERT INTO EMP VALUES(101,'ALLEN',105);
INSERT INTO EMP VALUES(102,'WARD',105);
INSERT INTO EMP VALUES(103,'MARTIN',105);
INSERT INTO EMP VALUES(104,'JONES',106);
INSERT INTO EMP VALUES(105,'BLAKE',106);
INSERT INTO EMP VALUES(106,'KING',NULL);
SELECT B.EMPNO, B.NAME, A.NAME AS BOSS
FROM EMP A, EMP B
...
SELECT * FROM MLPCOMMENT ORDER BY NO DESC;

SELECT * FROM mlpmember;
DELETE FROM MLPMEMBER WHERE NO=3;

CREATE SEQUENCE SEQ_MLPREPLY NOCACHE;
DROP SEQUENCE SEQ_MLPREPLY;
DROP TABLE MLPREPLY;
CREATE TABLE MLPREPLY(
	NO NUMBER PRIMARY KEY,
	CNO NUMBER NOT NULL,
	ID VARCHAR2(1000) NOT NULL,
	NAME VARCHAR2(1000) NOT NULL,
