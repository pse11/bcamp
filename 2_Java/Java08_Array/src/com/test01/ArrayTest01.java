...
public class ArrayTest01 {
	...
	public void testArray2() {
		...
		//iarr = new int[3]; //자바는 힙 영역에 누군가 참조안한 특정 변수가 있으면 사라진다. 그래서 변수에 할당시켜 줘야함
	...
	public void testArray3() {
		//정수값을 저장하는 크기가 5인 배열
		int iarr[] = new int[5];
		//배열의 초기값은 0이라는 값이 들어가있다.
		System.out.println(iarr[0]);
		for(int i=0;i<iarr.length;i++) {
			System.out.println(iarr[i]);
		}
		//0 출력
		//heap영역은 값이 없는 공간이 존재할 수 없다. = 비어있을 순 없다.
		//배열을 선언하고 할당을 하면 지정된 값으로 초기화가 진행된다.
//		스택은 빈거 만들고 기다림, 힙은 빈거만듦과 동시에 초기화됨
	//	스택은 공간의 크기가 정해져있음(int는 4바이트로 정해져있음), 힙은 공간의 크기가 정해져있지 않음(배열과 같이 사용자 마음인것들)
	//	double[] darr; //참조형 변수
	//	String str; //참조형 변수
	//	int no; //기본 자료형 변수
		
	//	System.out.println(darr.length+str+no);
		/*
