...
public class Variable01 {
	public static void main(String[] args) {
		...
		snum = 2;
		inum = 4;
		lnum = 8L; //이것도 뒤에 L을 작성해줘야하지만 8만 적어도 작동된다.
	...
	//메소드 생성 => 함수, 기능
	public void initVar() { //호출해줘야지 이 함수가 돌아간다.
		//변수 선언과 동시에 초기화
